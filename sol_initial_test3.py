...
il y'aura une chance de rentrer dans une boucle infinie même si elle est trops petite

le principe de l'heursitique constructive qu'on a adapté dans ce programme : le remplissage de planning s'effectue par colonne et chaque colonne j
doit vérifier les contraintes de besoin journalier et au même temps les contraintes sur les lignes qui sont les contraintes du personnel, 
de séquence, d'espacement et d'équilibre avant de remplir la colonne j+1 qui suit
